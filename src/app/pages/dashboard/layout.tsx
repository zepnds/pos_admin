...
<body className="antialiased h-full">
    ...
    <div className="h-full w-full flex overflow-hidden antialiased text-gray-800 bg-white">
        ...
        <nav aria-label="side bar" aria-orientation="vertical"
            ...
            <ul>
                <li>
                    <a title="Home" href="#home" className="h-16 px-6 flex items-center text-white bg-teal-700 w-full">
                        <i className="mx-auto">
            ...
            <svg className="fill-current h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path d="M19 7.001c0 3.865-3.134 7-7 7s-7-3.135-7-7c0-3.867 3.134-7.001 7-7.001s7 3.134 7 7.001zm-1.598 7.18c-1.506 1.137-3.374 1.82-5.402 1.82-2.03 0-3.899-.685-5.407-1.822-4.072 1.793-6.593 7.376-6.593 9.821h24c0-2.423-2.6-8.006-6.598-9.819z" />
                ...
                <li>
                    <a title="Reporting" href="#reporting" className="h-16 px-6 flex items-center hover:text-white w-full">
                        <i className="mx-auto">
            <svg className="fill-current h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div className="flex-1 flex flex-col">
            ...
            <ul id="add" role="listbox" className="outline-none py-2 bg-white border rounded-md w-screen max-w-md w-dropdown-large shadow-lg focus:outline-none leading-relaxed">
              ...
              <li role="option" className="px-6 py-1 my-1 focus:outline-none focus:bg-blue-100 hover:bg-blue-100 cursor-pointer">
                <div className="flex">
                  <div className="pr-2">
                    <span  className="font-mono rounded-sm bg-red-600 text-white leading-none">O</span>
        </div>
    ...
    <li role="option" className="px-6 py-1 my-1 focus:outline-none focus:bg-blue-100 hover:bg-blue-100 cursor-pointer">
        <div className="flex">
            <div className="pr-2">
                <span  className="font-mono rounded-sm bg-yellow-400 text-black leading-none">N</span>
            </div>
            <div className="flex-1">
                <p>Vertias - ams opps issue</p>
                <p className="text-gray-600">
    ...
    <li role="option" className="px-6 py-1 my-1 focus:outline-none focus:bg-blue-100 hover:bg-blue-100 cursor-pointer">
        <div className="flex">
            <div className="pr-2">
                <span  className="font-mono rounded-sm bg-gray-500 text-white leading-none">S</span>
            </div>
            <div className="flex-1">
                <p>Vertias - ams opps issue</p>
                <p className="text-gray-600">
    ...
    <li role="option" className="px-6 py-1 my-1 focus:outline-none focus:bg-blue-100 hover:bg-blue-100 cursor-pointer">
        <div className="flex">
            <div className="pr-2">
                <span  className="font-mono rounded-sm bg-gray-800 text-white leading-none">H</span>
            </div>
            <div className="flex-1">
                <p>Vertias - ams opps issue</p>
                <p className="text-gray-600">
    ...
    <ul aria-label="top bar right" aria-orientation="horizontal" className="px-8 flex items-center">
        <li className="relative">
            <input title="Search Bar" aria-label="search bar" role="search" className="pr-8 pl-4 py-2 rounded-md cursor-pointer transition-all duration-300 ease-in-out focus:border-black focus:cursor-text w-4 focus:w-64 placeholder-transparent focus:placeholder-gray-500" type="text" placeholder="Search Chi Desk Support" />
        ...
        <li className="h-8 w-8 ml-3">
            <button title="v2 REPL" aria-label="repl" className="w-full h-full text-white bg-gray-600 rounded-md focus:outline-none focus:shadow-outline">
            <i>
              <svg className="fill-current w-4 h-4 mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <li className="h-8 w-8 ml-3">
            <button title="Products" aria-label="chi desk products" className="w-full h-full rounded-md focus:outline-none focus:shadow-outline">
            <i className="text-gray-600">
              <svg className="fill-current w-5 h-5 mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <main  className="flex-grow flex min-h-0 border-t">
        ...
        <section className="flex flex-col p-4 w-full max-w-sm flex-none bg-gray-100 min-h-0 overflow-auto">
            ...
            <ul>
                ...
                <img className="h-8 w-8 rounded-md" src="https://raw.githubusercontent.com/bluebrown/tailwind-zendesk-clone/master/public/assets/avatar.png" />
              </span>
                        <div className="flex-1">
        ...
        <section aria-label="main content" className="flex min-h-0 flex-col flex-auto border-l">
            ...
            <nav className="bg-gray-100 flex p-4">
                ...
                <section aria-labelledby="open-tickets-tabs-label" className="mr-4 focus:outline-none">
                    <label id="open-tickets-tabs-label" className="font-semibold block mb-1 text-sm">Open Tickets
              <span className="font-normal text-gray-700">(current)</span>
                ...
                <section aria-labelledby="ticket-statistics-tabs-label" className="pb-2">
                    <label id="ticket-statistics-tabs-label" className="font-semibold block mb-1 text-sm">Ticket Statistics
            ...
            <header className="bg-white border-t flex items-center py-1 px-4">
              ...
              <button role="details" aria-controls="info-popup" className="text-blue-700 border-b border-dotted border-blue-700 focus:outline-none text-sm">
                What is this?
              </button>
              <div role="tooltip" id="info-popup" className="absolute pt-1 rounded-md rounded-t-lg right-0 transform translate-x-40 mx-auto hidden group-hover:block z-50">
                ...
                <div className="ml-auto">
                    <button title="See available tickets in this view" aria-label="play" className="border rounded-md px-3 py-2 leading-none">
              Play
            </button>
                </div>
            </header>
                ...
                <tbody className="flex w-full flex-col flex-1 min-h-0 overflow-hidden px-4">
                    ...
                    <tr className="border-b flex">
                        <th className="bg-gray-100 text-left px-3 py-2 flex-1" colspan="7">
                            <h2 className="text-sm">
                                <span className="font-normal mr-1">Priority</span><span>Low</span>
                            </h2>
                        </th>
                    </tr>
                    <tr role="row" className="hover:bg-blue-100 border-b flex cursor-pointer">
                        <td role="cell" headers="select" className="py-3 pl-3 pr-1 w-24 flex items-start">
                          ...
                          position: relative;
                          bottom: 2px;
                        " className="font-mono rounded-sm bg-red-600 text-white leading-none">O</span>
                                <!-- dropdown -->
                    ...
                    <article>
                      <header>
                        <div>
                          <span className="px-3 py-1 uppercase text-xs leading-none rounded-sm bg-red-600 text-white">Open</span>
                    ...
                    <tr role="row" className="hover:bg-blue-100 border-b flex cursor-pointer">
                        <td role="cell" headers="select" className="py-3 pl-3 pr-1 w-24 flex items-start">
                          ...
                          position: relative;
                          bottom: 2px;
                        " className="font-mono rounded-sm bg-yellow-400 text-black leading-none">N</span>
                                <!-- dropdown -->
                                <span className="hidden group-hover:block ml-4 mt-10 w-screen max-w-lg absolute top-0 border shadow-lg p-6 bg-white rounded-md z-50 text-gray-900">
                    <article>
                      <header>
                        <div>
                          <span className="px-3 py-1 uppercase text-xs leading-none rounded-sm bg-yellow-400 text-black">New</span>
                                <span className="ml-2 text-gray-700">Incident #12534</span>
                                <span className="ml-1">(Low)</span>
                            </div>
                            </header>
