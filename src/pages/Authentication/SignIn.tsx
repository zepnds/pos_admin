...
import DefaultInput from '../../components/Forms/Input/Default';
    ...
    <div className=" min-h-screen rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center ">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-20 sm:p-20 lg:p-10 xl:p-25 2xl:p-50">
            <span className="mb-1.5 block font-medium">
              Start for 1 month free
            </span>
            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
              Sign In to Multi Business Management Software
            </h2>
